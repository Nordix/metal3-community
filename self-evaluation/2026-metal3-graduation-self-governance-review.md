...
defining a four-level [contributor ladder][contributor-ladder],
...
single organization. Additional infrastructure is provided by
multiple vendors: OpenInfra Europe/Nordix donates managed CI
services (Jenkins, Artifactory), 1Password donates key management,
Netlify donates DNS and hosting services, and Red Hat donates
Quay.io for release container storage.
...
- **CI Team:** Reachable at <metal3-ci@googlegroups.com>. Must
  be an Organization Member. Onboarding is handled by maintainers
  with Org Admin access; the formal process definition is being
  refined ([CONTRIBUTOR-ROLE.md][roles]).
...
followed by discussion and a vote requiring a majority of yes
votes and zero no votes (a no vote acts as a veto). Offboarding
...
and Red Hat. Red Hat has approvers in the core repositories
(BMO, IrSO, Ironic-image), while Ericsson has approvers across
all repositories including CAPM3 and IPAM. This distribution
ensures no single vendor controls the project's direction,
though broadening approver diversity in CAPM3 and IPAM beyond
Ericsson is an active goal.

Beyond the two main sponsor organizations, the project also has
active reviewers and core members from additional organizations
such as Orange and SUSE, as well as independent contributors.
This cross-organizational participation at the reviewer level
further broadens the project's contributor base and strengthens
its survivability.
...
| [cluster-api-provider-metal3](https://github.com/metal3-io/cluster-api-provider-metal3) | CAPI infrastructure provider for bare metal | Stable (v1.13.x) | 7 approvers (Ericsson) |
| [ip-address-manager](https://github.com/metal3-io/ip-address-manager) | IP address allocation for bare metal hosts | Stable (v1.13.x) | 7 approvers (Ericsson) |
| [ironic-standalone-operator](https://github.com/metal3-io/ironic-standalone-operator) | Kubernetes operator for Ironic deployment | Beta (v0.x) | 5 approvers (Red Hat, Ericsson) |
| [ironic-image](https://github.com/metal3-io/ironic-image) | Container image for OpenStack Ironic | Stable | 5 approvers (Red Hat, Ericsson) |
| [ironic-ipa-downloader](https://github.com/metal3-io/ironic-ipa-downloader) | Ironic Python Agent image downloader | Stable | 5 approvers (Red Hat, Ericsson) |
| [mariadb-image](https://github.com/metal3-io/mariadb-image) | Container image for MariaDB (Ironic backend) | Archived | — |
| [metal3-dev-env](https://github.com/metal3-io/metal3-dev-env) | Development and testing environment | Stable | 6 approvers (Red Hat, Ericsson) |
| [metal3-docs](https://github.com/metal3-io/metal3-docs) | Design documents and proposals | N/A | 7 approvers (Red Hat, Ericsson) |
| [metal3-io.github.io](https://github.com/metal3-io/metal3-io.github.io) | Project website and blog | N/A | 7 approvers (Red Hat, Ericsson) |
| [project-infra](https://github.com/metal3-io/project-infra) | CI/CD infrastructure and jobs | Stable | 5 approvers (Red Hat, Ericsson) |
| [utility-images](https://github.com/metal3-io/utility-images) | Utility container images for CI | Stable | 5 approvers (Red Hat, Ericsson) |
...
by maintainer consensus, and the
...
[Metal3 YouTube playlist][youtube]. Community meetings are
scheduled, recorded, and facilitated via
[LFX Project Management](https://lfx.linuxfoundation.org/tools/project-management/)
tools, providing vendor-agnostic and automated meeting
management.
...
[CONTRIBUTING.md][contributing] document covering DCO sign-off, finding
